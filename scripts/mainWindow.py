...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dateTimeEd.setGeometry(QtCore.QRect(740, 370, 151, 22))
        self.dateTimeEd.setObjectName("dateTimeEd")
        self.lbl_date = QtWidgets.QLabel(self.centralwidget)
        self.lbl_date.setGeometry(QtCore.QRect(640, 370, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.img_photo.setGeometry(QtCore.QRect(40, 380, 141, 181))
        self.img_photo.setObjectName("img_photo")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(810, 400, 121, 81))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.btnStartVideo = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btnStartVideo.setObjectName("btnStartVideo")
        self.verticalLayout_2.addWidget(self.btnStartVideo)
        self.btnStopVideo = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.btnStopVideo.setObjectName("btnStopVideo")
        self.verticalLayout_2.addWidget(self.btnStopVideo)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnStartVideo.setText(_translate("MainWindow", "start"))
        self.btnStopVideo.setText(_translate("MainWindow", "stop"))
